...
function setupFileOperationsListeners(app) {
    ...
    const ipcHandlers = {
        'save-library': library_handler_1.libraryHandlers.saveData(app),
        'save-network': network_handler_1.networkHandlers.saveData(app),
        'save-history': history_handler_1.historyHandlers.saveData(app),
